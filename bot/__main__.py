    ...
    for i in itertools.count():
        ...
        try:
            ...
            if not WORKING and QUEUE:
                ...
                e = await bot.send_message(encode_channel_id, "**📥 Downloading Queue Files...**")
                ...
                ds = await e.client.send_file(
                    ...
                    filz_chanmnel_id , file=ok, force_document=True, caption=dk, link_preview=False, thumb=thum, parse_mode="html"
